    ...
    <div className="tw-bg-gray-800 tw-w-full tw-h-screen tw-grid tw-grid-cols-8 tw-p-5">
      ...
      <div className="tw-col-span-5 tw-flex tw-flex-col tw-items-center tw-justify-center tw-gap-10">
          <div className="tw-flex tw-flex-col tw-gap-2 tw-w-full tw-max-w-[372px]">
            <strong className="tw-text-heading-lg tw-leading-short tw-text-gray-100">Boas vindas!</strong>
            <span className="tw-text-md tw-leading-base tw-text-gray-200">Faça seu login ou acesse como visitante.</span>
          </div>

          <div className="tw-w-full tw-space-y-4 tw-max-w-[372px]">
            <button className="tw-rounded-lg tw-flex tw-items-center tw-gap-5 tw-w-full tw-text-lg tw-leading-base tw-text-gray-200 tw-bg-gray-600 tw-px-6 tw-py-5 hover:tw-bg-gray-500 hover:tw-text-white tw-transition-colors tw-border tw-border-gray-600">
              <GoogleIcon />
              Entrar com Google
            </button>
